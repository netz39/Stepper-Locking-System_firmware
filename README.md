...
| <img src="images/DoorWantsToClose.svg" width="250">| The ring is full with green. In the crossbar a red dot is running back and forth.             | A closing operation is planned but the door wing is still open. Close it to continue the operation. |
| <img src="images/warning.svg" width="250">        | Yellows distributed over the circle are wiggeling back and forth. | A unplanned event occurs. That can be step losses, hall encoder failure or external motor movement. However a normal operation is still possible by simply short press on the open/close buttons. <br/> See [Troubleshooting section](#Troubleshooting) for more details. |
